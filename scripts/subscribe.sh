...
SCREATES="CREATE subscription testsub CONNECTION 'dbname=dvdrental host=localhost port=5411 user=mtmuser' PuBLICATION testpub with(create_slot=false, slot_name=testpubslot, copy_data=false);"
